            ...
            <form class="row g-3" action="{{ route('doctor.update', ['doctor' => $doctor->slug]) }}" method="post">
                ...
                <div class="col-12 d-flex justify-content-around">
                    <div class="col-5">
                        ...
                        <input required maxlength="255" type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $userDetail->name) }}">
                        @error('name')
                    ...
                    <div class="col-5">
                        ...
                        <input required maxlength="255" type="text" class="form-control @error('lastname') is-invalid @enderror" id="lastname" name="lastname" value="{{ old('lastname', $userDetail->lastname) }}">
                        @error('lastname')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
