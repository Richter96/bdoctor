    ...
    public function run()
    {
        ...
        $messages = [
            ...
            (object) [
                ...
                'created_at' => Carbon::createFromFormat('Y-m-d', '2023-07-07')->toDateTimeString(),
                'doctor_id' => 7,
            ],
            (object) [
            ...
            (object) [
                ...
                'created_at' => Carbon::createFromFormat('Y-m-d', '2023-07-12')->toDateTimeString(),
                'doctor_id' => 9,
            ],
            (object) [
        ...
        foreach ($messages as $message) {
            ...
            $message_create->doctor_id = $message->doctor_id;
